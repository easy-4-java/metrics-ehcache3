...
> **Status**: scaffold module on the `feature/3.0.x` line (JDK 8). The pom, license and build plumbing are in place; no source code or tests exist in this branch yet. Artifacts are not yet published to Maven Central.
